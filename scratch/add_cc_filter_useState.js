...
const targetStr = `  const [ccMeetingsLog, setCcMeetingsLog] = useState<any[]>([]);`;
const insertText = `  const [ccMeetingsLog, setCcMeetingsLog] = useState<any[]>([]);
...
if (newTxt !== txt) {
  ...
  console.log('Inserted CC filter near useState');
} else {
